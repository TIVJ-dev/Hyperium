...
public interface IAddon {
  ...
  /**
   * Invoked once the plugin has successfully loaded {@see cc.hyperium.internal.addons.AddonMinecraftBootstrap#init}
   */
  void onLoad();

  /**
   * Invoked once the game has been closed this is executed at the start of {@link
